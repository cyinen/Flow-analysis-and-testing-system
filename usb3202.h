...
#ifdef _WIN64
#pragma comment(lib, "USB3202_64.lib")
#pragma message("======== Welcome to use our art company's products!")
#pragma message("======== Automatically linking with USB3202_64.dll...")
#pragma message("======== Successfully linked with USB3202_64.dll")
#else
#pragma comment(lib, "USB3202.lib")
#pragma message("======== Welcome to use our art company's products!")
#pragma message("======== Automatically linking with USB3202.dll...")
#pragma message("======== Successfully linked with USB3202.dll")
#endif
